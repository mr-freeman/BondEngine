...
namespace be::game
{
	...
	void SkyBox::initialize()
	{
		...
		VSShader = Graphics::GraphicsEngine::GetShaderManager()->CreateShader(Core::FileSystem::LoadFileToString("shaders//skybox_vs.hlsl"), SHADER_TYPE_VERTEX);
		PSShader = Graphics::GraphicsEngine::GetShaderManager()->CreateShader(Core::FileSystem::LoadFileToString("shaders//skybox_ps.hlsl"), SHADER_TYPE_PIXEL);
